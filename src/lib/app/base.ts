...
const useGatewayUrl = (import.meta.env.VITE_IOTA_USE_GATEWAY_URL as string)?.toLowerCase() !== 'false'
const config: ClientConfig = {
    ...
    auditTrailUrl: !useGatewayUrl ? (import.meta.env.VITE_IOTA_AUDIT_TRAIL_URL as string) : undefined,
    ssiBridgeUrl: !useGatewayUrl ? (import.meta.env.VITE_IOTA_SSI_BRIDGE_URL as string) : undefined,
