...
import type { ClientConfig } from 'iota-is-sdk';
import { ApiVersion, ChannelClient, IdentityClient } from 'iota-is-sdk';
...
export const authenticated = derived(authenticationData, $authenticationData => !!$authenticationData?.jwt);
