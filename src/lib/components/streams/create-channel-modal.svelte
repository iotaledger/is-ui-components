    ...
    <form class:was-validated={formValidated} on:submit|preventDefault bind:this={formContainer} novalidate>
        <ModalBody class="px-4 pb-4">
            <div class="my-4 p-4 bg-light ">
                ...
                <div id="hidden-input-container" class="d-inline-block">
                    <Input type="switch" class="mb-3" bind:checked={hidden} label="Hidden Channel" />
                </div>
                <Tooltip placement="right" target={'hidden-input-container'}>
                    If set to true the channel can not be found by others. It will be still possible to give specific users access
                    to the channel.
                </Tooltip>
                <br />
